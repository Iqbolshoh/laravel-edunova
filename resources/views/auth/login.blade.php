    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 p-8 sm:p-10">
            ...
            <form class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" placeholder="sizning@email.uz" class="block w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-white/10 rounded-xl text-sm text-white placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300 hover:border-white/20" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" name="password" placeholder="Parolingizni kiriting" class="block w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-white/10 rounded-xl text-sm text-white placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300 hover:border-white/20" />
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input type="checkbox" id="remember" name="remember" class="h-4 w-4 bg-slate-900 border-white/20 text-blue-500 focus:ring-blue-500 rounded transition-colors" />
                ...
                {{-- Submit Button --}}
                <button type="submit" class="w-full flex justify-center items-center gap-2 px-6 py-4 bg-gradient-to-r from-emerald-400 to-blue-400 hover:from-emerald-300 hover:to-blue-300 text-slate-900 font-bold rounded-xl shadow-lg shadow-blue-500/20 transition-all duration-300 hover:scale-[1.02] active:scale-95">
            ...
            <p class="mt-8 text-center text-sm text-slate-300">
                Hisobingiz yo'qmi?
                <a href="/register" class="font-bold text-emerald-400 hover:text-emerald-300 transition-colors ml-1">
                    Ro'yxatdan o'tish
                </a>
            </p>
