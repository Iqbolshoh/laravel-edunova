            ...
            <nav class="flex-1 px-3 py-6 space-y-6 overflow-y-auto">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="#" class="flex items-center px-4 py-2.5 rounded-xl transition-all duration-200 text-slate-400 hover:bg-slate-800/50 hover:text-white">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- Group 3: Admin Panel (faqat adminlar uchun) --}}
